...
public class StudentConverter {
  ...
  public List<StudentDetail> convertStudentDetails(List<Student> studentList,
    ...
    studentList.forEach(student -> {
      ...
      List<CourseStatus> convertCourseStatusList = courseStatusList.stream().filter(
              courseStatus -> convertStudentCourseList.stream()
                  .anyMatch(studentCourse -> studentCourse.getId().equals(courseStatus.getCourseId())))
          .collect(Collectors.toList());
